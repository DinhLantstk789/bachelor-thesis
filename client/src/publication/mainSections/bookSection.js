...
export default function BookSection (){
    const{bookSectionTitle,bookSectionPublicationPlace,bookSectionPublisher,bookSectionPageNumber,bookSectionSeriesName,bookSectionISBN,bookSectionVolume,
        bookSectionNumber ,bookSectionFirstPage,bookSectionEndPage}= useSelector(store =>({
